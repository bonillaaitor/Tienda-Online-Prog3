...
public class RecursividadContraseñas {

	
	private final char[] LETTERSandSYMBOLS = "ABCDEFGHIJKLMNOPQRSTUVWXYZ#@&%".toCharArray();
	...
	/**
		 *
		 */
		public RecursividadContraseñas() {
			r = new Random();
		}
	...
	private char getRandomLetter() {
		return LETTERSandSYMBOLS[r.nextInt(LETTERSandSYMBOLS.length)];
	}
